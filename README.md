...
When you open **Timesheet** for the first time in Google Sheets:
1. Click **Extensions** → **Timesheet** → **Create report** (or **Start timer**).
...
1. In Google Sheets, go to **Extensions** → **Timesheet** → **Start timer**.
...
1. In Google Sheets, go to **Extensions** → **Timesheet** → **Create report**.
...
2. Click **Extensions** → **Timesheet** → **Send report by email**.
...
1. Cliquez sur le menu **Extensions** → **Timesheet** → **Créer un rapport** (ou **Lancer le chronomètre**).
...
1. Dans Google Sheets, allez dans le menu **Extensions** → **Timesheet** → **Lancer le chronomètre**.
...
1. Dans Google Sheets, allez dans **Extensions** → **Timesheet** → **Créer un rapport**.
...
2. Cliquez sur **Extensions** → **Timesheet** → **Envoyer le rapport par email**.
