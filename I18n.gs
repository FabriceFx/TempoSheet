...
const TEXTES_ = {
  ...
  sidebarExportTitle: { fr: 'TempoSheet',                    en: 'TempoSheet' },
  ...
  timerInvalidRange:{ fr: 'Durée invalide : la fin précède le début.', en: 'Invalid duration: the end precedes the start.' },
  timerTooLong:     { fr: "Durée de {duree} non confirmée. Enregistrement refusé.", en: 'Unconfirmed duration of {duree}. Recording refused.' },

  // --- Chronomètre oublié (barre latérale) ---
  timerLongWarning:    { fr: 'Ce chronomètre tourne depuis {duree}. Il a probablement été oublié.', en: 'This timer has been running for {duree}. It was probably left on.' },
  timerBtnSaveAnyway:  { fr: 'Enregistrer quand même',    en: 'Save anyway' },
  timerBtnResume:      { fr: 'Reprendre le chronomètre',  en: 'Resume timer' },
  timerBtnDiscard:     { fr: 'Abandonner',                en: 'Discard' },
  timerDiscarded:      { fr: 'Chronomètre abandonné.',    en: 'Timer discarded.' },
  ...
  emailFooter:    { fr: "Ce rapport a été généré automatiquement par TempoSheet.", en: 'This report was automatically generated by TempoSheet.' },
  ...
  // --- Aide ---
  helpTitle: { fr: 'TempoSheet', en: 'TempoSheet' },
  ...
  helpL5:    { fr: 'Allez dans le menu <strong>Extensions</strong> → <strong>TempoSheet</strong> → <strong>Créer un rapport</strong>.', en: 'Go to the menu <strong>Extensions</strong> → <strong>TempoSheet</strong> → <strong>Create report</strong>.' },
